...
knitr::include_graphics("fig/fig2-alt-launching-app.png")
```

Since our application is still empty, launching it will generate a blank page that looks something like this:

```{r, echo=F, fig:blank-page, fig.cap="Figure 3. Launching a Blank Application"}
...
knitr::include_graphics("fig/fig6-exploring-normal-text.jpg")
```
