...
```{r, echo=FALSE, fig:dashboard-structure, fig.cap="Figure 37. Empty Dashboard Application"}
knitr::include_graphics("fig/fig37-dashboard-structure.png") 
```
...
```{r, echo=FALSE, fig:flight-delays-dashboard, fig.cap="Figure 38. Flight Delay Dashboard"}
knitr::include_graphics("fig/fig38-flight-dashboard.png") 
```
...
```{r, echo=FALSE, fig:flight-delays-dashboard-revised, fig.cap="Figure 39. Flight Delay Dashboard With Airport Selector"}
knitr::include_graphics("fig/fig39-flight-dashboard-airport.png") 
```
